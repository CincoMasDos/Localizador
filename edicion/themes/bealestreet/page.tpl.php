  ...
  <tr>
    ...
    <td valign="top">
      ...
      <?php endif; ?>
        ...
        <?php print $content; ?>
        <!--<?php print $feed_icons; ?> Comentado para que no se vea el icono RSS en la Página principal-->
...
<div id="footer">
  <!--<?php print $footer_message ?>
	<br /><a href="http://www.roopletheme.com" title="RoopleTheme!"><img src="<?php print base_path() . path_to_theme() . "/roopletheme.png"; ?>" alt="RoopleTheme"/></a> Comentado para ser sustituido por lo que sigue-->
	<a rel="license" 
  ...
  <a href="/localizador"
     style="color: white">   Localizador   </a>
  <a href="/localizador/generador.html"
     style="color: white"> Generador </a>           
</div>
